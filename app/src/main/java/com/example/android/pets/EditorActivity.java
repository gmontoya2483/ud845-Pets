...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get the intnet that was used to launch the activity from {@link CatalogActivity}
    ...
    private void savePet(){
        ...
        if (!isEditMode){
            ...
            if(newRowUri != null){
                ...
                Log.e(LOG_TAG,"Error with saving the new pet");
            }
        }else{
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,   //Parent context
                mCurrentPetUri,   //Provider content URI to query
                projection,             //Columns to include in the resulting Cursor (null = *)
                null,                   // Where clause
